  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-2 md:space-y-3 px-4 md:px-6 pb-4 md:pb-6">
        <div className="cursor-pointer -mx-4 md:-mx-6 px-4 md:px-6 py-2 md:py-3 bg-gray-50 hover:bg-gray-100 transition-colors border-t border-gray-200 flex items-center justify-center gap-2 text-xs md:text-sm font-medium text-alpine-blue-500">
          {isExpanded ? (
            <>
